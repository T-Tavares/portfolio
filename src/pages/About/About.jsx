            ...
            <article className={style.articles}>
                ...
                <article>
                    ...
                    <p>
                        ...
                        <br />
                        <br />
                        When I came to New Zealand, I wasn't building any expectations. I was just here to learn
                        English. But life has a way of surprising you and after six years of challenges, perseverance,
                        and growth, I became a Permanent Resident.
                        <br />
                        <br />
                        Refocusing on my career, I graduated in Digital Marketing through NZIE, but the pandemic threw a
                        wrench in those plans. Even so, I kept my “I'm not giving up” mindset. Once things settled, I
                        immersed myself in web development, starting with a year of self-study in JavaScript.
                        <br />
                        <br />
                        Then, I discovered Mission Ready, where I took a serious step toward my tech career. I graduated
                        as a Full Stack Developer, mastering skills like TypeScript, SASS, Node.js, React, and more.
                        <br />
                        <br />
                        One of the biggest surprises in my journey came when Mission Ready reached out and asked if I
                        wanted to join their team as an Assistant Trainer. It was a happy and unexpected turn, allowing
                ...
                <article>
                    <h3>Mission Ready</h3>
                    <p>
                        I've recently finished a Full Stack Accelerator course (Web Development) at Mission Ready. And I
                        am very grateful that I ended up there. It's been an intense and fun learning process with some
                        amazing people. <br />
                        <br />
                        After that I had the pleasure of being invited to join the team as an Assistant Trainer. And I
                        could not be more grateful.
                        <br />
                        Alongside with my first job in the tech industry, I've been building my first big project with
                        the amazing <a href="https://www.songsworks.com/">Song Yi Feng</a>. A designer I crossed paths
                        with at Mission Ready. And I can promise you that there are some amazing things coming up.
                    </p>
                </article>
            </article>
        </Box>
