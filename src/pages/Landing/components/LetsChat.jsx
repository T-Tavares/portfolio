    ...
    return (
        <Box title="Let's Chat" className={style.letsChatContainer} expandLabel="View About" expandPath="#about">
            <form className={style.form} action="mailto:thiago.tavares.freire@gmail.com">
                ...
                <input type="text" name="name" placeholder="Your Email" autoComplete="off" />
                <input type="text" name="subject" placeholder="Subject" autoComplete="off" res />
                <textarea name="message" cols="50" rows="8" placeholder="Your Message" autoComplete="off"></textarea>
                <input type="submit" />
            </form>
